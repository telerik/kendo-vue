...
const configs = {
  ...
  planning: { title: "Warehouse shift planning", subtitle: "Coordinate roasting, fulfilment, and quality coverage across coffee warehouse shifts.", tableTitle: "Today's shift roster", tableDescription: "Assigned staff, work zones, and coverage for the current operating day.", metrics: [["SCHEDULED STAFF", "58", "Across three shifts", "success"], ["OPEN SHIFTS", "3", "Requires coverage", "warning"], ["CONFLICTS", "0", "No overlapping assignments", "success"]], columns: ["Employee", "Team", "Shift", "Zone", "Status"], rows: [["Elena Morris", "Fulfilment", "06:00 - 14:00", "Picking A", "On shift"], ["Malik Bowen", "Roasting", "07:00 - 15:00", "Roastery", "On shift"], ["Avery Kim", "Quality", "08:00 - 16:00", "Lab 2", "Scheduled"]] },
