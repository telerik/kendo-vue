...
<style scoped>
.transactions-card { padding: var(--kendo-spacing-4); gap: calc(3.5 * var(--kendo-spacing-base)); border-radius: var(--kendo-border-radius-lg); }
.transactions-heading { display: grid; gap: var(--kendo-spacing-4); }
</style>
