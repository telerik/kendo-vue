...
page_title: Kendo UI for Vue Rating Documentation | Rating  Accessibility
description: "Get started with the Kendo UI for Vue Rating and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
...
Out of the box, the Kendo UI for Vue Rating provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
For more details about the Rating component's keyboard navigation, refer to the article on [keyboard navigation in the Rating component]({% slug keyboard_navigation_rating %}).
