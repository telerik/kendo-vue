---
title: Precision
description: "Sets the precision mode of the Kendo UI for Vue Rating in Vue projects."
...
{% meta height:260 %}
{% embed_file rating/precision/main.vue preview %}
{% embed_file rating/precision/main.js %}
{% endmeta %}
...
{% meta height:260 %}
{% embed_file rating/precision/first-full/main.vue preview %}
{% embed_file rating/precision/first-full/main.js %}
{% endmeta %}
...
{% meta height:260 %}
{% embed_file rating/precision/first-half/main.vue preview %}
{% embed_file rating/precision/first-half/main.js %}
{% endmeta %}
