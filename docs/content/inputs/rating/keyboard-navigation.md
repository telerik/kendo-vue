...
description: "Use the Kendo UI for Vue Rating keyboard navigation in Vue projects."
...
{% meta height:100 %}
{% embed_file rating/navigation/main.vue preview %}
{% embed_file rating/navigation/main.js %}
{% endmeta %}
