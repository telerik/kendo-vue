---
title: Labels
description: "Manage the labels of the Kendo UI for Vue Native RangeSlider in Vue projects."
...
{% meta height:130 %}
{% embed_file rangeslider/labels/main.vue preview %}
{% embed_file rangeslider/labels/main.js %}
{% endmeta %}
