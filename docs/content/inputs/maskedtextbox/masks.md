---
title: Masks
description: "Set and configure the built-in mask rules of the Kendo UI for Vue MaskedTextBox in Vue projects."
...
{% meta height:200 %}
{% embed_file maskedtextbox/masks/basic/main.vue preview %}
{% embed_file maskedtextbox/masks/basic/main.js %}
{% endmeta %}

The following example demonstrates how to extend the available mask rules.

{% meta height:450 %}
{% embed_file maskedtextbox/masks/extend/main.vue preview %}
{% embed_file maskedtextbox/masks/extend/main.js %}
{% endmeta %}
