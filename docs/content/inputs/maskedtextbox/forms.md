---
title: Forms Support
description: "Use the native HTML5 forms implementation of the Kendo UI for Vue MaskedTextBox component in Vue projects."
...
The MaskedTextBox supports a native Kendo UI for Vue implementation of [HTML5 form validation](https://developer.mozilla.org/en-US/docs/Learn/HTML/Forms/Form_validation).
...
{% meta height:450 %}
{% embed_file maskedtextbox/forms/validation/main.vue preview %}
{% embed_file maskedtextbox/forms/validation/main.js %}
{% endmeta %}
...
{% meta height:450 %}
{% embed_file maskedtextbox/forms/custom-message/main.vue preview %}
{% embed_file maskedtextbox/forms/custom-message/main.js %}
{% endmeta %}
...
{% meta height:450 %}
{% embed_file maskedtextbox/forms/enforce/main.vue preview  %}
{% embed_file maskedtextbox/forms/enforce/main.js %}
{% endmeta %}
...
{% meta height:450 %}
{% embed_file maskedtextbox/forms/disable-style/main.vue preview  %}
{% embed_file maskedtextbox/forms/disable-style/main.js %}
{% endmeta %}
