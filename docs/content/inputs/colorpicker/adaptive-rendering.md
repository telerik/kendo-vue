...
description: 'Enable adaptive rendering for the Kendo UI for Vue ColorPicker in Vue projects.'
...
{% meta height:670 %}
{% embed_file colorpicker/adaptive-rendering/main.vue preview %}
{% embed_file colorpicker/adaptive-rendering/main.js %}
{% endmeta %}
