...
page_title: Vue PDF Processing Component & Styling of Content | Kendo UI for Vue Native Docs & Demos
description: "Style the output document when you export content by using the Kendo UI for Vue PDF Processing components in Vue projects."
slug: stylingofcontent_pdf_processing
position: 11
---
...
{% meta height:450 %}
{% embed_file content-styling/class/main.vue preview %}
{% embed_file content-styling/class/main.js %}
{% embed_file content-styling/class/styles.css %}
{% endmeta %}
...
{% meta height:450 %}
{% embed_file content-styling/element/main.vue preview %}
{% embed_file content-styling/element/main.js %}
{% embed_file content-styling/element/styles.css %}
{% endmeta %}
