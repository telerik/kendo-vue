<template>
  <div>
    <div class="example-config">
      <KButton @click="exportDefaultResolution">Export PDF</KButton>
    </div>
    <PDFExport :scale="0.6" :paper-size="'A4'" margin="2cm" ref="contentToExport">
      <p>
...
function exportDefaultResolution() {
