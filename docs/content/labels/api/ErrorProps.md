---
title: ErrorProps
description: "Learn how to build custom functionality when working with the Vue Labels by Kendo UI with the help of the ErrorProps."
api_reference: true
type: inner_api
slug: api_labels_errorprops
---
