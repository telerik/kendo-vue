...
page_title: Kendo UI for Vue ChunkProgressBar Documentation | ChunkProgressBar  Accessibility
description: "Get started with the Kendo UI for Vue ChunkProgressBar and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
tags: telerik,kendo,vue,accessibility,wai-aria,wcag
slug: accessibility_chunkprogressbar
position: 100
---

# ChunkProgressBar Accessibility



Out of the box, the Kendo UI for Vue ChunkProgressBar provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
...
[ProgressBar accessibility specification]({% slug accessibility_progressbar %})
