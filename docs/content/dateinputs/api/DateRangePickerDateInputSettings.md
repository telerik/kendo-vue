...
description: "Learn how to build custom functionality when working with the Vue Dateinputs by Kendo UI with the help of the DateRangePickerDateInputSettings."
api_reference: true
type: inner_api
