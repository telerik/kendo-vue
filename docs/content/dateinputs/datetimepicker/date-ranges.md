---
title: Date and Time Limits
description: "Define the start and end date and time when working with the Kendo UI for Vue DateTimePicker in Vue projects."
...
{% meta height:610 %}
{% embed_file datetimepicker/ranges/date/main.vue preview %}
{% embed_file datetimepicker/ranges/date/main.js %}
{% endmeta %}
...
{% meta height:610 %}
{% embed_file datetimepicker/ranges/time/main.vue preview %}
{% embed_file datetimepicker/ranges/time/main.js %}
{% endmeta %}
