...
description: "Bind the Kendo UI for Vue DateTimePicker to dates which are serialized as strings in Vue projects."
...
{% meta height:640 %}
{% embed_file datetimepicker/json/main.vue preview %}
{% embed_file datetimepicker/json/main.js %}
{% endmeta %}
