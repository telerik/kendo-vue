---
title: Placeholders
description: "Render a text hint or provide descriptions for the format sections of the Kendo UI for Vue DateTimePicker in Vue projects."
...
For its input field, the DateTimePicker enables you to [provide descriptions for the format sections](#toc-setting-the-description-of-the-format-sections).
...
{% meta height:780 %}
{% embed_file datetimepicker/placeholders/main.vue preview %}
{% embed_file datetimepicker/placeholders/main.js %}
{% endmeta %}
