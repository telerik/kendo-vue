---
title: Forms Support
description: "Use the native HTML5 forms implementation of the Kendo UI for Vue DatePicker component in Vue projects."
...
[The Vue DatePicker component]({% slug overview_datepicker %}) supports a native Kendo UI for Vue implementation of [HTML5 form validation](https://developer.mozilla.org/en-US/docs/Learn/HTML/Forms/Form_validation).
...
{% meta height:530 %}
{% embed_file datepicker/forms/basic/main.vue preview %}
{% embed_file datepicker/forms/basic/main.js %}
{% endmeta %}
...
{% meta height:530 %}
{% embed_file datepicker/forms/custom-message/main.vue preview %}
{% embed_file datepicker/forms/custom-message/main.js %}
{% endmeta %}
...
{% meta height:530 %}
{% embed_file datepicker/forms/override/main.vue preview %}
{% embed_file datepicker/forms/override/main.js %}
{% endmeta %}
...
{% meta height:530 %}
{% embed_file datepicker/forms/disable-styles/main.vue preview %}
{% embed_file datepicker/forms/disable-styles/main.js %}
{% endmeta %}
