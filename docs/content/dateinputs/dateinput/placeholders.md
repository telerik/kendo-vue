---
title: Placeholders
description: "Handle the way the format sections of the Kendo UI for Vue DateInput input field are rendered."
...
{% meta height:380 %}
{% embed_file dateinput/placeholders/main.vue preview %}
{% embed_file dateinput/placeholders/main.js %}
{% endmeta %}
