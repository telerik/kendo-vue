---
title: Default Value
description: "Set the default value of the Kendo UI for Vue TimePicker in Vue projects."
...
{% meta height:520 %}
{% embed_file timepicker/default-value/main.vue preview %}
{% embed_file timepicker/default-value/main.js %}
{% endmeta %}
...
{% meta height:520 %}
{% embed_file timepicker/default-show/main.vue preview %}
{% embed_file timepicker/default-show/main.js %}
{% endmeta %}
