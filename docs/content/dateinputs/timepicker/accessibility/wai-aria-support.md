...
page_title: Kendo UI for Vue TimePicker Documentation | TimePicker  Accessibility
description: "Get started with the Kendo UI for Vue TimePicker and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
