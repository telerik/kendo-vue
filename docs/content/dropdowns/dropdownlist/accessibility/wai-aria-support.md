...
page_title: Kendo UI for Vue DropDownList Documentation | DropDownList  Accessibility
description: "Get started with the Kendo UI for Vue DropDownList and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
...
Out of the box, the Kendo UI for Vue DropDownList provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
