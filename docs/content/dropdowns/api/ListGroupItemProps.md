---
title: ListGroupItemProps
description: "Learn how to build custom functionality when working with the Vue Dropdowns by Kendo UI with the help of the ListGroupItemProps."
api_reference: true
type: inner_api
slug: api_dropdowns_listgroupitemprops
---
