...
description: "Enable the virtual scrolling functionality of the Kendo UI for Vue ComboBox in Vue projects."
...
{% meta height:340 %}
{% embed_file combobox/virtualization/basic/main.vue preview %}
{% embed_file combobox/virtualization/basic/main.js %}
{% endmeta %}
...
{% meta height:340 %}
{% embed_file combobox/virtualization/filtering/main.vue preview %}
{% embed_file combobox/virtualization/filtering/main.js %}
{% endmeta %}
...
{% meta height:340 %}
{% embed_file combobox/grouping/virtualization/main.vue preview %}
{% embed_file combobox/grouping/virtualization/main.js %}
{% endmeta %}
