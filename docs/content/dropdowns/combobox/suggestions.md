---
title: Suggestions
description: "Enable the suggestions of the Kendo UI for Vue ComboBox during user input in Vue projects."
...
{% meta height:350 %}
{% embed_file combobox/suggest/main.vue preview %}
{% embed_file combobox/suggest/main.js %}
