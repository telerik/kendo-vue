...
description: Learn how to handle license key file and environment variable name changes introduced with the 2025 Q1 release of Kendo UI for Vue.
...
tags: license, key, file, name, change, environment, variable, kendo-ui, telerik, vue
res_type: kb
