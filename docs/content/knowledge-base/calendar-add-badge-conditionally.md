...
Use the [`cell`](slug:api_dateinputs_calendarprops#toc-cell) prop to render a custom component that will render a [Badge](slug:overview_badge) based on the required condition.
