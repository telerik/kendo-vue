...
description: "Learn how to build custom functionality when working with the Vue Excel by Kendo UI with the help of the ExcelExportOptions."
api_reference: true
type: inner_api
slug: api_excel-export_excelexportoptions
---
...
any[] | [ExcelExportColumnOptions]({% slug api_excel-export_excelexportcolumnoptions %})[]
