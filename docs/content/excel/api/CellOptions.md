---
title: CellOptions
description: "Learn how to build custom functionality when working with the Vue Excel by Kendo UI with the help of the CellOptions."
api_reference: true
type: inner_api
slug: api_excel-export_celloptions
---
