...
description: "Learn how to build custom functionality when working with the Vue Animation by Kendo UI with the help of the AnimationEventArguments."
api_reference: true
type: inner_api
slug: api_animation_animationeventarguments
---
