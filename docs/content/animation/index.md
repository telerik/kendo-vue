...
# Kendo UI for Vue Native Animation Overview
...
* [Configuration]({% slug configuration_animation %})
* [Types]({% slug animationtypes_animation %})
* [Disabled animations]({% slug disabledstate_animation %})
* [Duration]({% slug duration_animation %})
* [Direction]({% slug direction_animation %})
* [Customization]({% slug customizing_animation %})
* [Appearance]({% slug appearance_animation %})

The Push Animations further extend the [`Animation`]({% slug api_animation_animationprops %}) component, which is commonly inherited by all Animation types, and enable you to stack animations.
...
### Using CDN
To use the Kendo UI for Vue Native Animation component with CDN, follow the below steps:

1. Reference the `animation` package.
...
* [Animation Homepage](https://www.telerik.com/kendo-vue-ui/animation)
* [API Reference of the Animation](slug:api_animation)
...
* [Animation Forum](https://www.telerik.com/forums/kendo-ui-vue?searchText=animation)
