<template>
  <FormElement :cols="2" :style="{ maxWidth: '850px' }">
    <FormFieldSet legend="Personal Information" :cols="2" :col-span="1">
      ...
      <Field :col-span="2" :name="'email'" :type="'email'" :label="'Email'" :component="'myTemplate'" :validator="emailValidator" :placeholder="'johndoe@myemail.com'">
        <template #myTemplate="{ props }">
          <FormInput v-bind="props" @change="props.onChange" @blur="props.onBlur" @focus="props.onFocus" />
        </template>
      </Field>
      <Field :col-span="2" :name="'phoneNumber'" :label="'Phone number'" :component="'maskedTemplate'" :mask="'(999) 000-00-00-00'" :validator="phoneValidator">
        <template #maskedTemplate="{ props }">
          <FormMaskedTextBox v-bind="props" @change="props.onChange" @blur="props.onBlur" @focus="props.onFocus" />
        </template>
      </Field>
    </FormFieldSet>
    <FormFieldSet legend="Reservation Details" :cols="2" :col-span="1">
