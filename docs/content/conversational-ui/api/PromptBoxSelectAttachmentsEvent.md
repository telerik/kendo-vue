...
description: "Learn how to build custom functionality when working with the Vue ConversationalUi by Kendo UI with the help of the PromptBoxSelectAttachmentsEvent."
api_reference: true
type: inner_api
