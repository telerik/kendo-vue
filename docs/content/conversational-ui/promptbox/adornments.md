---
title: Adornments
description: 'Learn how to enhance the Kendo UI for Vue PromptBox component with icons, buttons, and other UI elements using adornments.'
...
{% meta height:400 %}
{% embed_file promptbox/adornments/start/main.vue preview %}
{% embed_file promptbox/adornments/start/main.js %}
{% endmeta %}
...
{% meta height:400 %}
{% embed_file promptbox/adornments/end/main.vue preview %}
{% embed_file promptbox/adornments/end/main.js %}
{% endmeta %}
...
{% meta height:300 %}
{% embed_file promptbox/adornments/top/main.vue preview %}
{% embed_file promptbox/adornments/top/main.js %}
{% embed_file promptbox/adornments/top/styles.css %}
{% endmeta %}
...
```html
<PromptBox :action-button-config="false">
  <template #startAffix="{ actionButtonProps }">
    <PromptBoxActionButton v-bind="actionButtonProps" />
  </template>
</PromptBox>
```
...
{% meta height:200 %}
{% embed_file promptbox/adornments/reorder/main.vue preview %}
{% embed_file promptbox/adornments/reorder/main.js %}
{% endmeta %}
...
{% meta height:200 %}
{% embed_file promptbox/adornments/disabled-items/basic/main.vue preview %}
{% embed_file promptbox/adornments/disabled-items/basic/main.js %}
{% endmeta %}
...
{% meta height:200 %}
{% embed_file promptbox/adornments/disabled-items/programmatic-control/main.vue preview %}
{% embed_file promptbox/adornments/disabled-items/programmatic-control/main.js %}
{% endmeta %}
