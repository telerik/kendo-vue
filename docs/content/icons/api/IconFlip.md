---
title: IconFlip
description: "Learn how to build custom functionality when working with the Vue Common by Kendo UI with the help of the IconFlip."
api_reference: true
type: inner_api
slug: api_common_iconflip
---
