---
title: IconSize
description: "Learn how to build custom functionality when working with the Vue Common by Kendo UI with the help of the IconSize."
api_reference: true
type: inner_api
slug: api_common_iconsize
---
