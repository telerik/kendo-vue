<template>
  <div style="margin: 18px">
    <h6>DropDownList with Changed Icon:</h6>
    <DropDownList :style="{ width: '230px' }" :data-items="sports" :default-value="'Basketball'" />
  </div>
  <div style="margin: 18px">
    <h6>Editor with Changed Bold Icon and Updated DropDownLists Icon:</h6>
    <Editor :tools="tools" :content-style="{ height: '80px' }" />
  </div>
</template>
