...
{% meta height:700 %}
{% embed_file selection/all-options/main.vue preview %}
{% embed_file selection/all-options/main.js %}
{% endmeta %}
...
{% meta height:520 %}
{% embed_file selection/multi-row-selection/controlled/main.vue preview %}
{% embed_file selection/multi-row-selection/controlled/main.js %}
{% endmeta %}
