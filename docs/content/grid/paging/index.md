---
title: Overview
description: 'Get started with the paging functionality of the Kendo UI for Vue Grid and learn how to split content into pages.'
components: ["datagrid"]
slug: paging_grid
position: 0
---
...
The Kendo UI for Vue Data Grid provides a flexible paging mechanism that enables users to navigate large datasets efficiently. The built-in pager allows for numeric and input-based navigation, as well as customizable paging components.

## Getting Started with the Kendo UI for Vue Data Grid Paging
...
The Kendo UI for Vue Grid supports paging in two modes:
...
{% meta height:470 %}
{% embed_file paging-basic/controlled/main.vue preview %}
{% embed_file paging-basic/controlled/main.js %}
{% endmeta %}
...
{% meta height:630 %}
{% embed_file paging/types/main.vue preview %}
{% embed_file paging/types/main.js %}
{% endmeta %}
