...
{% meta height:520 %}
{% embed_file paging-custom-pager/main.vue preview %}
{% embed_file paging-custom-pager/main.js %}
{% endmeta %}
...
{% meta height:480 %}
{% embed_file custom-pager-responsive/main.vue preview %}
{% embed_file custom-pager-responsive/main.js %}
{% endmeta %}
