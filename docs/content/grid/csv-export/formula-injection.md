...
description: "Learn how to protect against CSV formula injection attacks in the Kendo UI for Vue Data Grid CSV export."
...
CSV formula injection is a security vulnerability where malicious formulas embedded in data can be executed when the CSV file is opened in spreadsheet applications like Microsoft Excel. The Kendo UI for Vue Data Grid CSV export includes built-in protection against this attack vector.
...
<demo metaUrl="grid/csv-export/formula-injection-enabled/" height="420"></demo>
...
```html
<template>
  <Grid :data-items="userSubmittedData" :csv="csvOptions">
    <GridCsvExportButton />
  </Grid>
</template>
