---
title: Clipboard
description: 'Get started with the clipboard functionality of the Kendo UI for Vue Data Grid and use it to copy, cut and paste cell data from and to the Data Grid.'
slug: clipboard_grid
position: 20
tag: new
---

# Vue Data Grid Clipboard
...
1. Handle the [`@clipboard`]({% slug api_grid_gridprops %}#toc-onclipboard) event and use the [`populateClipboardData`]({% slug api_data-tools_populateclipboarddata %}) function to update the Data Grid data as necessary by using the available copied cells.
...
{% meta height:720 %}
{% embed_file clipboard/clipboard-basic/main.vue preview %}
{% embed_file clipboard/clipboard-basic/main.js %}
{% embed_file clipboard/clipboard-basic/gd-products.js %}
{% endmeta %}
...
-   [`cellDelimiter`]({% slug api_data-tools_clipboardsettings %}#toc-celldelimiter)&mdash;Determines what is the delimiter used to separate the cells. Defaults to `'\t'`.
...
{% meta height:550 %}
{% embed_file clipboard/clipboard-headers/main.vue preview %}
{% embed_file clipboard/clipboard-headers/main.js %}
{% embed_file clipboard/clipboard-headers/gd-products.js %}
{% endmeta %}
