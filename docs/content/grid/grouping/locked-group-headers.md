...
description: 'Get started with the Kendo UI for Vue Data Grid enabling you to visualize locked columns when the grouping is enabled.'
components: ["datagrid"]
...
The Kendo UI for Vue Data Grid allows you to lock the headers of the grouped data and freeze the component columns at the same time when needed.
...
{% meta height:580 %}
{% embed_file locked-group-headers/main.vue preview %}
{% embed_file locked-group-headers/main.js %}
{% embed_file locked-group-headers/gd-products.js %}
{% endmeta %}
