...
<CtaPanelOverview title="New to Kendo UI for Vue?" message="@ProductLink is a professionally-built commercial UI library. Simply sign up for a 30-day trial to get access to all 100+ components, high-quality learning resources and our award-winning technical support."></CtaPanelOverview>
...
* More details about the TypeScript support you can find on our [TypeScript Integration](slug:overview_typescript_integration) page.
...
Kendo UI for Vue supports [integration with Tailwind CSS](slug:tailwind_getting_started), allowing you to leverage utility-first styling alongside Kendo UI for Vue components. You can easily combine Tailwind classes with Kendo UI for Vue components for rapid customization and consistent design.
