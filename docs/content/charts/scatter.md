---
title: Scatter
description: "Basic usage of the Kendo UI for Vue Scatter Plot and Scatter Line charts in Vue projects."
...
{% meta height:465 %}
{% embed_file chart/scatter-plot/main.vue preview %}
{% embed_file chart/scatter-plot/main.js %}
{% embed_file shared/scatter-plot-data.json %}
{% endmeta %}

The following example demonstrates the Scatter Line chart in action.

{% meta height:500 %}
{% embed_file chart/scatter-line/main.vue preview %}
{% embed_file chart/scatter-line/main.js %}
{% embed_file shared/scatter-line-data.json %}
{% endmeta %}
...
Scatter Line charts enable you to render the lines between the points in different styles. To set the appearance of the lines, use the [`line.style`]({% slug api_charts_seriesline %}#toc-style) option which provides the following available styles:
...
{% meta height:500 %}
{% embed_file chart/scatter-line-style/main.vue preview %}
{% embed_file chart/scatter-line-style/main.js  %}
{% embed_file shared/scatter-line-style-data.json %}
{% endmeta %}
