---
title: ChartPlotAreaProps
description: "Learn how to build custom functionality when working with the Vue Charts by Kendo UI with the help of the ChartPlotAreaProps."
api_reference: true
type: inner_api
slug: api_charts_chartplotareaprops
---

# ChartPlotAreaProps
Represents the props of the Kendo UI for Vue ChartPlotArea component ([see example]({% slug plotarea_chart_charts %})).
