---
title: ChartNavigatorProps
description: "Learn how to build custom functionality when working with the Vue Charts by Kendo UI with the help of the ChartNavigatorProps."
api_reference: true
type: inner_api
slug: api_charts_chartnavigatorprops
---
