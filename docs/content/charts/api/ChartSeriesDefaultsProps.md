...
description: "Learn how to build custom functionality when working with the Vue Charts by Kendo UI with the help of the ChartSeriesDefaultsProps."
api_reference: true
type: inner_api
...
Represents the props of the Kendo UI for Vue ChartSeriesDefaults component ([see example]({% slug series_chart_charts %}#toc-default-series-configuration)).
...
string | [Overlay]({% slug api_charts_overlay %})
