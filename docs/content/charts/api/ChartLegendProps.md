...
description: "Learn how to build custom functionality when working with the Vue Charts by Kendo UI with the help of the ChartLegendProps."
api_reference: true
type: inner_api
...
# ChartLegendProps
Represents the props of the Kendo UI for Vue ChartLegend component ([see example]({% slug legend_chart_charts %})).
