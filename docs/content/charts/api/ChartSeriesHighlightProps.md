...
description: "Learn how to build custom functionality when working with the Vue Charts by Kendo UI with the help of the ChartSeriesHighlightProps."
api_reference: true
type: inner_api
...
Represents the props of the Kendo UI for Vue ChartSeriesHighlight component.
