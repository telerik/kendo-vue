...
description: "Learn how to build custom functionality when working with the Vue Charts by Kendo UI with the help of the ChartPaneProps."
api_reference: true
type: inner_api
...
# ChartPaneProps
Represents the props of the Kendo UI for Vue ChartPane component ([see example]({% slug panes_chart_charts %})).
