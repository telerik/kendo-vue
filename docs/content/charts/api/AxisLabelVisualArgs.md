---
title: AxisLabelVisualArgs
description: "Learn how to build custom functionality when working with the Vue Charts by Kendo UI with the help of the AxisLabelVisualArgs."
api_reference: true
type: inner_api
slug: api_charts_axislabelvisualargs
---
