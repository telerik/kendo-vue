---
title: ChartAreaProps
description: "Learn how to build custom functionality when working with the Vue Charts by Kendo UI with the help of the ChartAreaProps."
api_reference: true
type: inner_api
slug: api_charts_chartareaprops
---

# ChartAreaProps
Represents the props of the Kendo UI for Vue ChartArea component ([see example]({% slug chartarea_chart_charts %})).
