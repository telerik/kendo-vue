...
description: "Learn the basic approaches to render a Kendo UI for Vue Chart component in Vue projects."
...
{% meta height:560 %}
{% embed_file chart/rendering/main.vue preview %}
{% embed_file chart/rendering/main.js %}
{% endmeta %}
