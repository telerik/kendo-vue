<template>
  <div>
    <KButton @click="onSVGExportClick">Export SVG</KButton>
    <Chart ref="chart">
      <ChartTooltip :visible="true" />
      <ChartCategoryAxis>
        <ChartCategoryAxisItem :categories="categories_months" :axisCrossingValue="[0, 20]" :start-angle="45" />
      </ChartCategoryAxis>
...
const exportChartVisual = (callback) => {
    const chartVisual = exportVisual(chart.value, {});
    if (chartVisual) {
