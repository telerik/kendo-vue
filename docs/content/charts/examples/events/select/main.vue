...
const categories = ref([2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011]);
const series = ref([
    {
        name: 'India',
        data: [
...
function onSelect() {
    events.value.unshift('Select event triggered');
}

function onSelectStart() {
    events.value.unshift('SelectStart event triggered');
}

function onSelectEnd() {
    events.value.unshift('SelectEnd event triggered');
}
</script>
