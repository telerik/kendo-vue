---
title: Heatmap
description: 'Basic usage of the Kendo UI for Vue Heatmap charts in Vue projects.'
...
{% meta height:300 %}
{% embed_file chart/heatmap/basic/main.vue preview %}
{% embed_file chart/heatmap/basic/main.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/heatmap/binding-objects/main.vue preview %}
{% embed_file chart/heatmap/binding-objects/main.js %}
{% endmeta %}
...
{% meta height:300 %}
{% embed_file chart/heatmap/binding-categories/main.vue preview %}
{% embed_file chart/heatmap/binding-categories/main.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/heatmap/color-scale/main.vue preview %}
{% embed_file chart/heatmap/color-scale/main.js %}
{% endmeta %}
...
{% meta height:600 %}
{% embed_file chart/heatmap/marker-shapes/main.vue preview %}
{% embed_file chart/heatmap/marker-shapes/main.js %}
{% endmeta %}
...
{% meta height:600 %}
{% embed_file chart/heatmap/marker-size/main.vue preview %}
{% embed_file chart/heatmap/marker-size/main.js %}
{% endmeta %}
...
{% meta height:500 %}
{% embed_file chart/heatmap/pan-zoom/main.vue preview %}
{% embed_file chart/heatmap/pan-zoom/main.js %}
{% endmeta %}
...
{% meta height:500 %}
{% embed_file chart/heatmap/tooltips/main.vue preview %}
{% embed_file chart/heatmap/tooltips/main.js %}
{% endmeta %}
...
{% meta height:500 %}
{% embed_file chart/heatmap/crosshairs/main.vue preview %}
{% embed_file chart/heatmap/crosshairs/main.js %}
{% endmeta %}
