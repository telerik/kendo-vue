---
title: Bubble
description: "Basic usage of the Kendo UI for Vue Bubble charts in Vue projects."
...
{% meta height:470 %}
{% embed_file chart/bubble/main.vue preview %}
{% embed_file chart/bubble/main.js %}
{% embed_file shared/bubble-data.json %}
{% endmeta %}
