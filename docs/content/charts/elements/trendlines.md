---
title: Trendlines
description: "Explore data trends by using trendlines in the Kendo UI for Vue Chart."
...
To define a trendline, define a [SeriesItem](slug:api_charts_chartseriesitemprops) and set its [`for`](slug:api_charts_chartseriesitemprops#toc-for) prop to the parent series name:

{% meta height:460 %}
{% embed_file chart/trendlines/basic/main.vue preview %}
{% embed_file chart/trendlines/basic/main.js %}
{% embed_file shared/sales-data.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/trendlines/linear/categorical/main.vue preview %}
{% embed_file chart/trendlines/linear/categorical/main.js %}
{% embed_file shared/sales-data.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/trendlines/linear/scatter/main.vue preview %}
{% embed_file chart/trendlines/linear/scatter/main.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/trendlines/exponential/categorical/main.vue preview %}
{% embed_file chart/trendlines/exponential/categorical/main.js %}
{% embed_file shared/sales-data.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/trendlines/exponential/scatter/main.vue preview %}
{% embed_file chart/trendlines/exponential/scatter/main.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/trendlines/logarithmic/categorical/main.vue preview %}
{% embed_file chart/trendlines/logarithmic/categorical/main.js %}
{% embed_file shared/sales-data.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/trendlines/logarithmic/scatter/main.vue preview %}
{% embed_file chart/trendlines/logarithmic/scatter/main.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/trendlines/power/categorical/main.vue preview %}
{% embed_file chart/trendlines/power/categorical/main.js %}
{% embed_file shared/sales-data.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/trendlines/power/scatter/main.vue preview %}
{% embed_file chart/trendlines/power/scatter/main.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/trendlines/polynomial/categorical/main.vue preview %}
{% embed_file chart/trendlines/polynomial/categorical/main.js %}
{% embed_file shared/sales-data.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/trendlines/polynomial/scatter/main.vue preview %}
{% embed_file chart/trendlines/polynomial/scatter/main.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/trendlines/moving-average/categorical/main.vue preview %}
{% embed_file chart/trendlines/moving-average/categorical/main.js %}
{% embed_file shared/sales-data.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/trendlines/moving-average/scatter/main.vue preview %}
{% embed_file chart/trendlines/moving-average/scatter/main.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/trendlines/custom-field/main.vue preview %}
{% embed_file chart/trendlines/custom-field/main.js %}
{% embed_file shared/stock-data-sample.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/trendlines/date-series/main.vue preview %}
{% embed_file chart/trendlines/date-series/main.js %}
{% embed_file shared/sales-data.js %}
{% endmeta %}
...
{% meta height:460 %}
{% embed_file chart/trendlines/forecast/main.vue preview %}
{% embed_file chart/trendlines/forecast/main.js %}
{% embed_file shared/sales-data.js %}
{% endmeta %}
...
By default, the trendlines are displayed in the [ChartLegend]({% slug api_charts_chartlegendprops %}). They can be toggled by clicking on the legend item as regular series. Hiding the main series will also hide the trendlines.
...
{% meta height:460 %}
{% embed_file chart/trendlines/hidden-legend-item/main.vue preview %}
{% embed_file chart/trendlines/hidden-legend-item/main.js %}
{% embed_file shared/sales-data.js %}
{% endmeta %}
