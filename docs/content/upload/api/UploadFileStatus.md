---
title: UploadFileStatus
description: "Learn how to build custom functionality when working with the Vue Upload by Kendo UI with the help of the UploadFileStatus."
api_reference: true
type: inner_api
slug: api_upload_uploadfilestatus
---
