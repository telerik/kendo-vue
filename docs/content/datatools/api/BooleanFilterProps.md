...
description: "Learn how to build custom functionality when working with the Vue Datatools by Kendo UI with the help of the BooleanFilterProps."
api_reference: true
type: inner_api
...
(event: { nextFilter: [FilterOperator]({% slug api_data-tools_filteroperator %}); }) => void
