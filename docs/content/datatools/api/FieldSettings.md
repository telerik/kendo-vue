---
title: FieldSettings
description: "Learn how to build custom functionality when working with the Vue Datatools by Kendo UI with the help of the FieldSettings."
api_reference: true
type: inner_api
slug: api_data-tools_fieldsettings
---
