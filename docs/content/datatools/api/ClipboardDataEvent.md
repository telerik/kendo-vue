...
description: "Learn how to build custom functionality when working with the Vue Datatools by Kendo UI with the help of the ClipboardDataEvent."
api_reference: true
type: inner_api
...
[ColumnBaseProps]({% slug api_data-tools_columnbaseprops %})[]
