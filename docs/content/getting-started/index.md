...
Kendo UI for Vue includes five gorgeous themes, which are all available as separate NPM packages. The available theme packages are [@progress/kendo-theme-default](https://www.npmjs.com/package/@progress/kendo-theme-default), [@progress/kendo-theme-bootstrap](https://www.npmjs.com/package/@progress/kendo-theme-bootstrap), [@progress/kendo-theme-material](https://www.npmjs.com/package/@progress/kendo-theme-material) , [@progress/kendo-theme-fluent](https://www.npmjs.com/package/@progress/kendo-theme-fluent) and [@progress/kendo-theme-meridian](https://www.npmjs.com/package/@progress/kendo-theme-meridian).
...
```
Next, add a [row click handler](slug:api_grid_gridprops#toc-onrowclick) to the Grid.
```html
