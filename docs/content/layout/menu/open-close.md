...
description: "Customize the opening and closing behavior of the Kendo UI for Vue Menu in Vue projects."
...
{% meta height:200 %}
{% embed_file menu/open-close/hover/main.vue preview %}
{% embed_file menu/open-close/hover/main.js %}
{% endmeta %}
...
{% meta %}
{% embed_file menu/open-close/click/main.vue preview %}
{% embed_file menu/open-close/click/main.js %}
{% endmeta %}
