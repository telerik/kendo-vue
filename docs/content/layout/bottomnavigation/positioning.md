---
title: Positioning
description: "Learn how to position the Kendo UI for Vue native BottomNavigation component in relation to the page content."
...
{% meta height:500 %}
{% embed_file bottomnavigation/position-mode/main.vue preview %}
{% embed_file bottomnavigation/position-mode/main.js %}
{% endmeta %}
