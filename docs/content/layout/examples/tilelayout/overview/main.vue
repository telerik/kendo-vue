  ...
  >
    ...
    <template #bouncerate>
      <div>
        ...
        <p>
          The percentage of all sessions on your site in which users viewed only
          a single page.
        </p>
      </div>
    </template>
...
const tiles = [
    { headerText: 'Page Views', body: 'pageviews' },
    { headerText: 'Most Visited Pages', body: 'popularpageschart' },
    { headerText: 'Users by Channel', body: 'usersgrid' },
    { headerText: 'Conversion Rate', body: 'conversionrate' },
    { headerText: 'Currently', body: 'currently' },
    { headerText: 'Bounce Rate', body: 'bouncerate' },
    { headerText: 'Visitors', body: 'visitors' },
    { headerText: 'Conversions This Month', body: 'conversions' },
];
