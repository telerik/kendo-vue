<template>
  ...
  >
    <template #firstTileBody>
      <p :style="styles">
        Tile is 1st in order. It's on the first column. Spans across two columns
        and one row.
      </p>
    </template>
    <template #secondTileBody>
      <p :style="styles">
        Tile is 2nd in order. It's on the first column. Spans across one column
        and one row.
      </p>
    </template>
    <template #thirdTileBody>
      <p :style="styles">
        Tile is 3rd in order. It's on the first column. Spans across three
        columns and one row.
      </p>
    </template>
    <template #fourthTileBody>
      <p :style="styles">
        Tile is 4th in order. It's on the second column and row unset. Spans
        across one column and one row.
      </p>
    </template>
    <template #fifthTileBody>
      <p :style="styles">
        Tile is 5th in order. It's on the third column and row unset. Spans
        across one column and two rows.
      </p>
    </template>
    <template #firstTileHeader> Tile 1 </template>
    <template #secondTileHeader> Tile 2 </template>
    <template #thirdTileHeader> Tile 3 </template>
    <template #fourthTileHeader> Tile 4 </template>
    <template #fifthTileHeader> Tile 5 </template>
  </TileLayout>
  <br />
  <br />
...
const events = ref([]);
const styles = { padding: '10px', fontSize: '12px' };
...
function onReposition() {
    events.value.unshift('Reposition event triggered.');
}
</script>
