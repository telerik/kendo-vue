<template>
  <div class="grid-layout-container">
    ...
    >
      ...
      <template #content2>
        <TrendingArticle :position="1" :article="articles[0]" />
      </template>
      <template #content3>
        <TrendingArticle :position="2" :article="articles[1]" />
      </template>
      <template #content4>
        <TrendingArticle :position="3" :article="articles[2]" />
      </template>
      <template #content5>
        <TrendingArticle :position="4" :article="articles[3]" />
      </template>
      <template #content6>
        <TrendingArticle :position="5" :article="articles[4]" />
      </template>
      <template #content7>
        <TrendingArticle :position="6" :article="articles[5]" />
      </template>
      <template #content8>
        <div class="k-text-inverse k-text-uppercase k-font-weight-bold">
          Recommended for you
      ...
      <template #content11>
        <div>
          <Calendar
            ...
            :navigation="false"
          />
          <div class="k-text-inverse k-text-uppercase k-font-weight-bold k-mt-4">
            Discover more
          </div>
          <ChipList
            :selection="'multiple'"
...
const handleValueChange = (event) => {
    selectedDate.value = new Date(event.value);
