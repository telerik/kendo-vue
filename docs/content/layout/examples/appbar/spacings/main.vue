<template>
  <div>
    <AppBar>
      <AppBarSection>
        <KButton fill-mode="flat" :svg-icon="menuIconRef"></KButton>
      </AppBarSection>
      ...
      <AppBarSpacer :width="68" />

      <AppBarSection>
        <KInput placeholder="Search Songs" />
      </AppBarSection>
      ...
      <AppBarSection>
        <KButton fill-mode="flat">
          <div class="badge">
            ...
            <Badge edge="inside" theme-color="info" size="small">8</Badge>
          </div>
        </KButton>
      </AppBarSection>
    </AppBar>
