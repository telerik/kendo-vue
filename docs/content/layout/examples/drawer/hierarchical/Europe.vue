<template>
  ...
  >
    <div :style="{ width: '47%' }">
      <Card>
        <CardImage :src="amsterdamImage" />
        <div>
          <CardHeader>
            <CardTitle>Amsterdam holiday</CardTitle>
            <CardSubtitle>
              <span class="reviews">
                <span class="k-icon k-i-star" :style="{ color: '#ffce2a' }" />
                <span class="k-icon k-i-star" :style="{ color: '#ffce2a' }" />
                <span class="k-icon k-i-star" :style="{ color: '#ffce2a' }" />
                <span class="k-icon k-i-star" :style="{ color: '#ffce2a' }" />
                <span class="k-icon k-i-star" />
                <div>4/5 (391)</div>
              </span>
            </CardSubtitle>
          </CardHeader>
          ...
          <CardActions>
            <KButton fill-mode="flat" theme-color="primary">Review</KButton>
          </CardActions>
        </div>
      </Card>
    </div>
...
const amsterdamImage =
  (import.meta.env.VITE_VUE_DEMOS_BASE_URL || "/") +
  "assets/layout/drawer/amsterdam.jpg";
const budapestImage =
  (import.meta.env.VITE_VUE_DEMOS_BASE_URL || "/") +
  "assets/layout/drawer/budapest.jpg";
</script>
