...
const sunnyImage = (import.meta.env.VITE_VUE_DEMOS_BASE_URL || "/") + "assets/layout/tabstrip/sunny.png";
const rainyImage = (import.meta.env.VITE_VUE_DEMOS_BASE_URL || "/") + "assets/layout/tabstrip/rainy.png";

const events = ref([]);
const selected = ref(0);
const tabs = ref([
    { title: "Paris", content: "Paris" },
    { title: "New York City", content: "NewYork" },
    { title: "Tallinn", content: "Tallin" },
    { title: "Sydney", content: "Tallin", disabled: true },
]);

const onSelect = (e) => {
    selected.value = e.selected;
    events.value.unshift('Tab ' + e.selected + ' was selected.');
};
</script>
