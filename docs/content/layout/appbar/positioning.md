---
title: Positioning
description: "Learn how to position the Kendo UI for Vue Native AppBar component in relation to the page content."
...
{% meta height:370 %}
{% embed_file appbar/position/main.vue preview %}
{% embed_file appbar/position/main.js %}
{% endmeta %}
...
{% meta height:380 %}
{% embed_file appbar/position-mode/main.vue preview %}
{% embed_file appbar/position-mode/main.js %}
{% endmeta %}
