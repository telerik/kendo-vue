...
page_title: Kendo UI for Vue Breadcrumb Documentation | Breadcrumb  Accessibility
description: "Get started with the Kendo UI for Vue Breadcrumb and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.2."
...
Out of the box, the Kendo UI for Vue Breadcrumb provides extensive accessibility support and enables users with disabilities to acquire complete control over its features.
