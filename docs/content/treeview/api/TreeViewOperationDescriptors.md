...
description: "Learn how to build custom functionality when working with the Vue Treeview by Kendo UI with the help of the TreeViewOperationDescriptors."
api_reference: true
type: inner_api
...
[TreeViewOperationDescriptor]({% slug api_treeview_treeviewoperationdescriptor %}) | string[]
