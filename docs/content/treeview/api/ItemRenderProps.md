---
title: ItemRenderProps
description: "Learn how to build custom functionality when working with the Vue Treeview by Kendo UI with the help of the ItemRenderProps."
api_reference: true
type: inner_api
slug: api_treeview_itemrenderprops
---
