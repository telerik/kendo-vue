<template>
  <div class="example">
    <div class="example-wrap">
      <div class="row">
        <div class="col-4">
          <p>Pulse animation (Default)</p>
          <Card>
            <CardHeader class="k-hbox">
              <Skeleton
                shape="circle"
                :style="{ width: '45px', height: '45px', 'margin-right': 16 }"
              />
            ...
            <Skeleton shape="rectangle" :style="{ width: '100%', height: '150px' }" />
            <CardFooter>
              <Skeleton shape="text" :style="{ width: '100%' }" />
            </CardFooter>
          </Card>
        ...
        <div class="col-4">
          ...
          <Card>
            ...
            <Skeleton shape="rectangle" :style="{ width: '100%', height: '150px' }" :animation="false" />
            <CardFooter>
              <Skeleton shape="text" :style="{ width: '100%' }" :animation="false" />
            </CardFooter>
          </Card>
...
import { Card, CardHeader, CardFooter } from '@progress/kendo-vue-layout';
</script>
