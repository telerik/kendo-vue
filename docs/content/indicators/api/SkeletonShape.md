---
title: SkeletonShape
description: "Learn how to build custom functionality when working with the Vue Indicators by Kendo UI with the help of the SkeletonShape."
api_reference: true
type: inner_api
slug: api_indicators_skeletonshape
---
