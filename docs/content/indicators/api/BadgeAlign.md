---
title: BadgeAlign
description: "Learn how to build custom functionality when working with the Vue Indicators by Kendo UI with the help of the BadgeAlign."
api_reference: true
type: inner_api
slug: api_indicators_badgealign
---
