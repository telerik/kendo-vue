---
title: Types
description: "Get started with the Kendo UI for Vue Native Notification package and learn more about how to use the types of notifications which display information about success, error, info, and warning application operations and processes."
...
{% meta height:400 %}
{% embed_file types/main.vue preview %}
{% embed_file types/main.js %}
{% endmeta %}
