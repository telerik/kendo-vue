<template>
  <div>
    ...
    >
      <h4>Armchair 402</h4>
      <div class="armchair"><img :src="armchairImage" alt="Armchair 402" /></div>
...
const armchairImage = (import.meta.env.VITE_VUE_DEMOS_BASE_URL || '/') + 'assets/dialogs/armchair-402.png'
