---
title: Positioning
description: "Learn how to position the Kendo UI for Vue FloatingActionButton in a relation to web page or Vue components."
...
The FloatingActionButton component provides options for positioning in relation to the page or Vue Component.
...
{% meta height:500 %}
{% embed_file floatingactionbutton/positioning/main.vue preview %}
{% embed_file floatingactionbutton/positioning/main.js %}
{% endmeta %}
...
{% meta height:200 %}
{% embed_file floatingactionbutton/align-offset/main.vue preview %}
{% embed_file floatingactionbutton/align-offset/main.js %}
{% endmeta %}
...
{% meta height:300 %}
{% embed_file floatingactionbutton/position-mode/main.vue preview %}
{% embed_file floatingactionbutton/position-mode/main.js %}
{% endmeta %}
