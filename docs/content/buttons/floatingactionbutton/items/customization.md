---
title: Customization
description: "Customize the popup and the popup items of the Kendo UI for Vue FloatingActionButton in Vue projects."
...
{% meta height:270 %}
{% embed_file floatingactionbutton/items/custom/popup/main.vue preview %}
{% embed_file floatingactionbutton/items/custom/popup/main.js %}
{% endmeta %}

## Items Rendering

To override the default rendering of all popup items, use the [`item`]({% slug api_buttons_floatingactionbuttonpopupsettings %}#toc-item) property of the FloatingActionButton.

{% meta height:350 %}
{% embed_file floatingactionbutton/items/custom/custom-rendering/main.vue preview %}
{% embed_file floatingactionbutton/items/custom/custom-rendering/CustomItem.vue %}
{% embed_file floatingactionbutton/items/custom/custom-rendering/main.js %}
{% endmeta %}
