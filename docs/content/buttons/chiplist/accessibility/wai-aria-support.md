...
page_title: Kendo UI for Vue ChipList Documentation | ChipList  Accessibility
description: "Get started with the Kendo UI for Vue ChipList and learn about its accessibility support for WAI-ARIA, Section 508, and WCAG 2.1."
