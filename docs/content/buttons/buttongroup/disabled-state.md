...
description: "Enable or disable the Kendo UI for Vue ButtonGroup in Vue projects."
...
{% meta height:150 %}
{% embed_file buttongroup/disabled/main.vue preview %}
{% embed_file buttongroup/disabled/main.js %}
{% endmeta %}
