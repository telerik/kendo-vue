---
title: Globalization
description: "Get started with the globalization functionality of the Kendo UI for Vue Native TreeList and learn how to localize built-in messages."
slug: globalization_treelist
position: 500
---

# Native TreeList Globalization

The globalization process combines the translation of component messages with adapting them to specific locales.

For more information on how globalization practices are implemented in Kendo UI for Vue Native suite, refer to the [overview article]({% slug overview_globalization %}). For more information on the globalization aspects which are available for each component, refer to the article on [globalization support]({% slug globalization_support %}).

The following example demonstrates how to use the Spanish date format and month names and how to localize the built-in messages of the Kendo UI for Vue Native TreeList component.
...
The TreeList supports the localization of its messages by utilizing the [Kendo UI for Vue Native Internationalization package]({% slug overview_intl %}).
