---
title: filterBy
description: "Learn how to build custom functionality when working with the Vue Treelist by Kendo UI with the help of the filterBy."
api_reference: true
type: inner_api
slug: api_treelist_filterby
---
