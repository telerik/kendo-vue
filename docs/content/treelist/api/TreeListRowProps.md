...
description: "Learn how to build custom functionality when working with the Vue Treelist by Kendo UI with the help of the TreeListRowProps."
api_reference: true
type: inner_api
...
(event: { dragged: number[]; draggedItem: any; draggedOver: number[]; nativeEvent: any; }) => void
