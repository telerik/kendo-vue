---
title: LinearScale
description: "Learn how to build custom functionality when working with the Vue Gauges by Kendo UI with the help of the LinearScale."
api_reference: true
type: inner_api
slug: api_gauges_linearscale
---
