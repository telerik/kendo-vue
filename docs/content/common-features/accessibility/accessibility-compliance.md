...
> You can review and download the latest version of the Kendo UI for Vue VPAT document [here](https://demos.telerik.com/kendo-vue-ui/assets/accessibility/VueVPAT2.4RevINT(June2023).pdf).
...
|`Breadcrumb`|`Yes`|`AAA`| `n/a` | [Documentation](slug:accessibility_breadcrumb) |
