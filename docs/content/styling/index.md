...
* [Default theme](https://www.telerik.com/design-system/docs/themes/kendo-themes/default/)&mdash;Available through the `@progress/kendo-theme-default` NPM module.
* [Bootstrap theme](https://www.telerik.com/design-system/docs/themes/kendo-themes/bootstrap/)&mdash;Available through the `@progress/kendo-theme-bootstrap` NPM module.
* [Material theme](https://www.telerik.com/design-system/docs/themes/kendo-themes/material/)&mdash;Available through the `@progress/kendo-theme-material` NPM module.
* [Fluent theme](https://www.telerik.com/design-system/docs/themes/kendo-themes/fluent/)&mdash;Available through the `@progress/kendo-theme-fluent` NPM module.
* [Classic theme](https://www.telerik.com/design-system/docs/themes/kendo-themes/classic/)&mdash;Available through the `@progress/kendo-theme-classic` NPM module.
* [Meridian theme](https://www.telerik.com/design-system/docs/themes/kendo-themes/meridian/)&mdash;Available through the `@progress/kendo-theme-meridian` NPM module.
...
* [Customize the Meridian theme](https://www.telerik.com/design-system/docs/themes/kendo-themes/meridian/customization/)
...
Kendo UI for Vue components [integrate with Tailwind CSS](slug:tailwind_getting_started) allowing you to enhance or customize their appearance. By combining Tailwind's utility classes with Kendo UI themes, you can achieve a unique look and streamline your styling workflow.
