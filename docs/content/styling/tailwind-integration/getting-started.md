...
description: 'Quick setup guide for integrating Telerik and Kendo UI Themes with Tailwind CSS in a Kendo UI for Vue project.'
slug: tailwind_getting_started
position: 10
---

# Getting Started with Kendo UI for Vue and Tailwind CSS

Get started with your Tailwind CSS and Kendo UI for Vue integration by following these simple steps.

## Prerequisites

In your [Kendo UI for Vue project](slug:getting_started_javascript_composition_api) verify that you have:
...
```vue
<template>
  <div class="bg-app-surface p-6 rounded-lg">
    <h1 class="text-lg font-bold text-primary-on-surface mb-4">
      Welcome to KendoVue
    </h1>
    <KButton class="mb-4">Themed Button</KButton>
    <div class="bg-primary border-2 border-solid border-secondary rounded-lg p-4">
      <p class="text-on-primary">Using Progress Design System colors</p>
    </div>
  </div>
</template>
...
-   [Customizing Kendo UI for Vue Components with Tailwind CSS](slug:tailwind_customization)
