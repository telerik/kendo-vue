...
description: "Learn how to build custom functionality when working with the Vue Scheduler by Kendo UI with the help of the SchedulerDragProps."
api_reference: true
type: inner_api
...
# SchedulerDragProps
Represents the props of the Kendo UI for Vue [SchedulerDrag] component.
