...
description: "Learn how to build custom functionality when working with the Vue Scheduler by Kendo UI with the help of the SchedulerFormProps."
api_reference: true
type: inner_api
...
# SchedulerFormProps
Represents the props of the Kendo UI for Vue [SchedulerForm]({% slug api_scheduler_schedulerformprops %}) component.
