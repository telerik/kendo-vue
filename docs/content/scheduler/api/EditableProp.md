---
title: EditableProp
description: "Learn how to build custom functionality when working with the Vue Scheduler by Kendo UI with the help of the EditableProp."
api_reference: true
type: inner_api
slug: api_scheduler_editableprop
---
