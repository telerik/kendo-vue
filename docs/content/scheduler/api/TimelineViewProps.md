...
description: "Learn how to build custom functionality when working with the Vue Scheduler by Kendo UI with the help of the TimelineViewProps."
api_reference: true
type: inner_api
...
# TimelineViewProps
Represents the properties of the Kendo UI for Vue [TimelineView]({% slug api_scheduler_timelineviewprops %}) Component.
...
Overrides the `slotRender` prop of the Scheduler for the specified view only.
