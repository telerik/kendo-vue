...
description: "Learn how to build custom functionality when working with the Vue Scheduler by Kendo UI with the help of the SchedulerViewTaskProps."
api_reference: true
type: inner_api
...
Represents the props of the Kendo UI for Vue [SchedulerViewTask]({% slug api_scheduler_schedulerviewtaskprops %}) component.
