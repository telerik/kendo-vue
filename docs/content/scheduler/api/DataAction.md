---
title: DataAction
description: "Learn how to build custom functionality when working with the Vue Scheduler by Kendo UI with the help of the DataAction."
api_reference: true
type: inner_api
...
# DataAction
Specifies the action which can be dispatched.
