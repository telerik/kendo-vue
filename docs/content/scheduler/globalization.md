---
title: Globalization
description: "Get started with the Kendo UI for Vue Scheduler which supports globalization by translating its messages and adapting them to specific cultures."
...
The following example demonstrates how to use the Spanish culture in the Native Kendo UI for Vue Scheduler.

{% meta height:770 %}
{% embed_file globalization/overview/main.vue preview %}
{% embed_file globalization/overview/main.js %}
{% embed_file globalization/overview/es.json %}
...
## Messages
 Scheduler supports the localization of its messages by utilizing the [Kendo UI for Vue Native Internationalization package]({% slug overview_intl %}).
