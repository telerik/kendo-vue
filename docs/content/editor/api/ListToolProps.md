---
title: ListToolProps
description: "Learn how to build custom functionality when working with the Vue Editor by Kendo UI with the help of the ListToolProps."
api_reference: true
type: inner_api
slug: api_editor_listtoolprops
---
