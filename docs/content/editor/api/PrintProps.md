---
title: PrintProps
description: "Learn how to build custom functionality when working with the Vue Editor by Kendo UI with the help of the PrintProps."
api_reference: true
type: inner_api
slug: api_editor_printprops
---
