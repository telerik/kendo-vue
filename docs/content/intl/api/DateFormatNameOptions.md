---
title: DateFormatNameOptions
description: "Learn how to build custom functionality when working with the Vue Intl by Kendo UI with the help of the DateFormatNameOptions."
api_reference: true
type: inner_api
slug: api_intl_dateformatnameoptions
---
