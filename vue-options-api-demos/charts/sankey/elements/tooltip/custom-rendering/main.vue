<template>
 <div>
    <Sankey
      ...
      :tooltip="{ nodeContent: 'nodeContent', linkContent: 'linkContent' }"
    >
      <template v-slot:nodeContent="{props}">
            <TooltipNodeContent v-bind="props" />
        </template>
        <template v-slot:linkContent="{props}">
            <TooltipLinkContent v-bind="props" />
        </template>
    </Sankey>
  </div>
</template>
...
import TooltipNodeContent from './tooltip-node-content.vue';
import TooltipLinkContent from './tooltip-link-content.vue';
