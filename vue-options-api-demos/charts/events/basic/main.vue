...
export default {
  ...
  methods: {
    ...
    onAxisLabelClick() {
      this.events.unshift("AxisLabelClick event triggered");
    },
    onLegendItemClick() {
      this.events.unshift("LegendItemClick event triggered");
    },
    onLegendItemHover() {
      this.events.unshift("LegendItemHover event triggered");
    },
    onNoteClick() {
      this.events.unshift("NoteClick event triggered");
    },
    onNoteHover() {
      this.events.unshift("NoteHover event triggered");
    },
    onPlotAreaClick() {
      this.events.unshift("PlotAreaClick event triggered");
    },
    onPlotAreaHover() {
      this.events.unshift("PlotAreaHover event triggered");
    },
    onSeriesClick() {
      this.events.unshift("SeriesClick event triggered");
    },
    onSeriesHover() {
      this.events.unshift("SeriesHover event triggered");
    },
  },
};
</script>
