    ...
    <div>
        <Grid
            ...
            <template v-slot:myTemplate="{props}">
                <custom  :data-item="props.dataItem" :field="props.field"
        ...
        <dragpointer v-if="showDropHints && showDragClueContent" :targetLeftOffset="targetLeftOffset" :targetTopOffset="targetTopOffset"  />
   </div>
</template>
<script>
