<template>
  <AppBar>
    ...
    <AppBarSection class="social-section">
      <KButton :fill-mode="'flat'">
      ...
      <KButton :fill-mode="'flat'">
        <SvgIcon :icon="pinterestIcon" />
      </KButton>
      <KButton :fill-mode="'flat'">
        <SvgIcon :icon="googleIcon" />
      </KButton>
    </AppBarSection>
  </AppBar>
  ...
  <AppBar :position="'bottom'" :theme-color="'dark'">
